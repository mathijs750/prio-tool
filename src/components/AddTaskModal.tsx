  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="button-group">
            {(['seed', 'plant', 'tree'] as Size[]).map((s) => (
              <button
                ...
                onClick={() => { setError(null); setSize(s); }}
                title={`Omvang ${s}`}
                aria-label={`Omvang ${s}`}
                aria-pressed={size === s}
              >
        ...
        {error && (
          <div role="alert" style={{ color: 'var(--prio-high)', fontWeight: 'var(--font-weight-bold)', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
