  ...
  return (
    <div className="quick-add-container">
      <form onSubmit={handleSubmit}>
        <label htmlFor="quick-add-input" style={{ position: 'absolute', width: '1px', height: '1px', padding: 0, margin: '-1px', overflow: 'hidden', clip: 'rect(0, 0, 0, 0)', whiteSpace: 'nowrap', border: 0 }}>Omschrijving nieuwe taak</label>
        <input
          id="quick-add-input"
          type="text"
