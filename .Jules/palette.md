...
**Learning:** Native alert() calls inside dialogs/modals block the main thread and lack proper accessibility context for screen readers.
**Action:** Always prefer inline error states with role="alert" over native alert() when validating form submissions, especially inside modals or dialogs.
